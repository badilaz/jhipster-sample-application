package com.zadilab.bpmf.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zadilab.bpmf.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zadilab.bpmf.repository.UserRepository.USERS_BY_EMAIL_CACHE);
