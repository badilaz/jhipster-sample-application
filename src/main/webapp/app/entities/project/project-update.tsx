...
export const ProjectUpdate = (props: IProjectUpdateProps) => {
  ...
  const { projectEntity, customers, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.project.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : projectEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="project-name">
                  <Translate contentKey="jhipsterSampleApplicationApp.project.name">Name</Translate>
                </Label>
                <AvField id="project-name" type="text" name="name" />
                <UncontrolledTooltip target="nameLabel">
                  <Translate contentKey="jhipsterSampleApplicationApp.project.help.name" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
                <Label id="codeLabel" for="project-code">
                  <Translate contentKey="jhipsterSampleApplicationApp.project.code">Code</Translate>
                </Label>
                <AvField id="project-code" type="text" name="code" />
              </AvGroup>
              <AvGroup>
                <Label for="project-customer">
                  <Translate contentKey="jhipsterSampleApplicationApp.project.customer">Customer</Translate>
                </Label>
                <AvInput id="project-customer" type="select" className="form-control" name="customer.id">
                  <option value="" key="0" />
                  {customers
